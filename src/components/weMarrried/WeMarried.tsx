  ...
  return (
    <section className="we-married">
      ...
      <p className="we-married__subtitle">
        ...
        familia y un hogar santo, Por esta razón después de 4 años de noviazgo
        hemos decidido casarnos y compartir con las personas mas especiales para
        nosotros, esta gran felicidad
      </p>
    </section>
  )
}
